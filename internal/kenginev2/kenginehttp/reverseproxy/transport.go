...
// for Kengine's reverse proxy. It builds its http.Transport at Provision.
type HTTPTransport struct {
	...
	FallbackDelay kengine.Duration `json:"dial_fallback_delay,omitempty"`

	// How long to wait for reading response headers from server. Default: No timeout.
	ResponseHeaderTimeout kengine.Duration `json:"response_header_timeout,omitempty"`
	...
	ExpectContinueTimeout kengine.Duration `json:"expect_continue_timeout,omitempty"`
...
type TLSConfig struct {
	...
	CA kenginetls.CA `json:"ca,omitempty"`
	...
	// If specified, Kengine will use and automate a client certificate
	...
	// The list of elliptic curves to support. Kengine's
...
type KeepAlive struct {
	...
	ProbeInterval kengine.Duration `json:"probe_interval,omitempty"`
	...
	IdleConnTimeout kengine.Duration `json:"idle_timeout,omitempty"`
}
