...
type PassiveHealthChecks struct {
	...
	FailDuration kengine.Duration `json:"fail_duration,omitempty"`
...
type LoadBalancing struct {
	...
	// SelectionPolicyRaw json.RawMessage `json:"selection,omitempty" kengine:"namespace=layer4.proxy.selection_policies inline_key=policy"`
